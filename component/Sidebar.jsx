...
export default function Sidebar({ active, onChange }) {
  ...
  // Updated isActive function to handle editflow route
  const isActive = (route) => {
    if (route === "/workflowlist") {
      // Consider workflow active if on workflowlist or editflow pages
      return (
        pathname === "/workflowlist" ||
        pathname.startsWith("/editflow") ||
        pathname.startsWith("/createflow")
      );
    }
