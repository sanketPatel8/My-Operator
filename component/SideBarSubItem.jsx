...
export function SidebarSubItem({ label, isOpen }) {
  ...
  return (
    <div className="group flex items-center  gap-2 mb-2 py-1 px-2 text-[16px] font-source-sans text-[#878EAA] hover:rounded-[46px] hover:bg-[#202332] hover:text-[#2bb0a3] cursor-pointer">
