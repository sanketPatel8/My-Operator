  ...
  return (
    ...
    <div className={`font-source-sans ${
      ...
      >
        ...
        {!sidebarOpen && <span>{isOpen ? <FaChevronDown size={12}/> : <FaChevronRight size={12}/>}</span>}
      </div>
      {isOpen && !sidebarOpen && <div className="pl-8 ">{children}</div>}
    </div>
    </>
  );
}
