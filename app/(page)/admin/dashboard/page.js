        ...
        <div className="space-y-6">
          ...
          <div>
            <Link
              ...
              className="block text-sm font-medium text-[#343E55] mb-2 hover:underline"
            >
              Reset Password?
            </Link>
          </div>
    ...
    <div className="flex justify-between items-center w-full my-3">
      ...
      <div>
        <input
          ...
          className="w-md px-4 py-2 border border-gray-300 rounded-md text-black text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      </div>
    </div>
  );
